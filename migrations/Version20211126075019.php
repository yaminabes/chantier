 ...
 */
final class Version20211126075019 extends AbstractMigration
{
    ...
    public function up(Schema $schema): void
    {
        ...
        $this->addSql('CREATE TABLE phase (id INT AUTO_INCREMENT NOT NULL, statut_id INT NOT NULL, nom_phase VARCHAR(255) NOT NULL, date_debut DATETIME NOT NULL, date_fin DATETIME NOT NULL, INDEX IDX_B1BDD6CBF6203804 (statut_id), PRIMARY KEY(id)) DEFAULT CHARACTER SET utf8mb4 COLLATE `utf8mb4_unicode_ci` ENGINE = InnoDB');
        ...
        $this->addSql('CREATE TABLE stock_tache_utilise (id INT AUTO_INCREMENT NOT NULL, stock_id INT DEFAULT NULL, tache_id INT DEFAULT NULL, quantite DOUBLE PRECISION NOT NULL, INDEX IDX_665869BEDCD6110 (stock_id), INDEX IDX_665869BED2235D39 (tache_id), PRIMARY KEY(id)) DEFAULT CHARACTER SET utf8mb4 COLLATE `utf8mb4_unicode_ci` ENGINE = InnoDB');
        $this->addSql('CREATE TABLE tache (id INT AUTO_INCREMENT NOT NULL, prestataire_id INT DEFAULT NULL, metier_id INT DEFAULT NULL, statut_id INT NOT NULL, nom_tache VARCHAR(255) NOT NULL, tarif_prestation DOUBLE PRECISION NOT NULL, date_debut DATETIME NOT NULL, date_fin DATETIME DEFAULT NULL, description LONGTEXT DEFAULT NULL, duree DATETIME NOT NULL, INDEX IDX_93872075BE3DB2B7 (prestataire_id), INDEX IDX_93872075ED16FA20 (metier_id), INDEX IDX_93872075F6203804 (statut_id), PRIMARY KEY(id)) DEFAULT CHARACTER SET utf8mb4 COLLATE `utf8mb4_unicode_ci` ENGINE = InnoDB');
        ...
        $this->addSql('ALTER TABLE phase ADD CONSTRAINT FK_B1BDD6CBF6203804 FOREIGN KEY (statut_id) REFERENCES statut (id)');
    ...
    public function down(Schema $schema): void
    {
        ...
        $this->addSql('ALTER TABLE phase DROP FOREIGN KEY FK_B1BDD6CBF6203804');
