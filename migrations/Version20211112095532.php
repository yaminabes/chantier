 ...
 */
final class Version20211112095532 extends AbstractMigration
{
    ...
    public function up(Schema $schema): void
    {
        ...
        $this->addSql('CREATE TABLE chantier (id INT AUTO_INCREMENT NOT NULL, phase_id INT NOT NULL, date_debut DATETIME NOT NULL, date_fin DATETIME NOT NULL, adresse VARCHAR(255) DEFAULT NULL, INDEX IDX_636F27F699091188 (phase_id), PRIMARY KEY(id)) DEFAULT CHARACTER SET utf8mb4 COLLATE `utf8mb4_unicode_ci` ENGINE = InnoDB');
        ...
        $this->addSql('ALTER TABLE chantier ADD CONSTRAINT FK_636F27F699091188 FOREIGN KEY (phase_id) REFERENCES phase (id)');
    ...
    public function down(Schema $schema): void
    {
        ...
        $this->addSql('ALTER TABLE chantier DROP FOREIGN KEY FK_636F27F699091188');
