 ...
 */
final class Version20211112182141 extends AbstractMigration
{
    ...
    public function up(Schema $schema): void
    {
        ...
        $this->addSql('ALTER TABLE user ADD maitre_ouvrage_id INT DEFAULT NULL, ADD conducteur_traveaux_id INT DEFAULT NULL, ADD prestataire_id INT DEFAULT NULL, ADD adresse VARCHAR(255) NOT NULL, ADD num_tel VARCHAR(255) NOT NULL, ADD roles LONGTEXT NOT NULL COMMENT \'(DC2Type:json)\', ADD nom VARCHAR(255) NOT NULL');
    ...
    public function down(Schema $schema): void
    {
        ...
        $this->addSql('ALTER TABLE `user` DROP maitre_ouvrage_id, DROP conducteur_traveaux_id, DROP prestataire_id, DROP adresse, DROP num_tel, DROP roles, DROP nom');
    }
}
